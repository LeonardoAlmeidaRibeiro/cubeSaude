                                            ...
                                            <form action="{{ route('meals.store') }}" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control @error('meal_type') is-invalid @enderror" id="meal_type" name="meal_type" required>
                                                        ...
                                                        <option value="cafe" {{ old('meal_type') == 'cafe' ? 'selected' : '' }}>Café da Manhã</option>
                                                        <option value="almoco" {{ old('meal_type') == 'almoco' ? 'selected' : '' }}>Almoço</option>
                                                        <option value="jantar" {{ old('meal_type') == 'jantar' ? 'selected' : '' }}>Jantar</option>
                                                        <option value="lanches" {{ old('meal_type') == 'lanches' ? 'selected' : '' }}>Lanches</option>
                                                    </select>
                                                    @error('meal_type')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" step="0.1" class="form-control @error('carbs') is-invalid @enderror" id="carbs" name="carbs" value="{{ old('carbs') }}">
                                                    @error('carbs')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="datetime-local" class="form-control @error('consumed_at') is-invalid @enderror" id="consumed_at" name="consumed_at" value="{{ old('consumed_at') }}">
                                                    @error('consumed_at')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
