        ...
        <div class="branding d-flex align-items-center">
            ...
            <div class="container position-relative d-flex align-items-center justify-content-end">
                <a href="{{route('dashboard')}}" class="logo d-flex align-items-center me-auto">
                    <img src="{{ asset('medicio/assets/img/logo.png')}}" alt="">
        ...
        <section id="hero" class="hero section">
            ...
            <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
                ...
                <div class="carousel-item active">
                    <img src="{{ asset('medicio/assets/img/hero-carousel/hero-carousel-1.jpg') }}" alt="">
                    <div class="container">
                ...
                <div class="carousel-item">
                    <img src="{{ asset('medicio/assets/img/hero-carousel/hero-carousel-2.jpg') }}" alt="">
                    <div class="container">
                ...
                <div class="carousel-item">
                    <img src="{{ asset('medicio/assets/img/hero-carousel/hero-carousel-3.jpg') }}" alt="">
                    <div class="container">
        ...
        <section id="features" class="features section">
            ...
            <div class="container">
                ...
                <div class="row justify-content-around gy-4">
                    <div class="features-image col-lg-6" data-aos="fade-up" data-aos-delay="100"><img src="{{ asset('medicio/assets/img/features.jpg') }}" alt=""></div>
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="swiper init-swiper">
                    ...
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery" href="{{ asset('medicio/assets/img/gallery/gallery-1.jpg') }}">
                                <img src="{{ asset('medicio/assets/img/gallery/gallery-1.jpg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery" href="{{ asset('medicio/assets/img/gallery/gallery-2.jpg') }}">
                                <img src="{{ asset('medicio/assets/img/gallery/gallery-2.jpg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery" href="{{ asset('medicio/assets/img/gallery/gallery-3.jpg') }}">
                                <img src="{{ asset('medicio/assets/img/gallery/gallery-3.jpg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery" href="{{ asset('medicio/assets/img/gallery/gallery-4.jpg') }}">
                                <img src="{{ asset('medicio/assets/img/gallery/gallery-4.jpg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery" href="{{ asset('medicio/assets/img/gallery/gallery-5.jpg') }}">
                                <img src="{{ asset('medicio/assets/img/gallery/gallery-5.jpg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery" href="{{ asset('medicio/assets/img/gallery/gallery-6.jpg') }}">
                                <img src="{{ asset('medicio/assets/img/gallery/gallery-6.jpg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery" href="{{ asset('medicio/assets/img/gallery/gallery-7.jpg') }}">
                                <img src="{{ asset('medicio/assets/img/gallery/gallery-7.jpg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery" href="{{ asset('medicio/assets/img/gallery/gallery-8.jpg') }}">
                                <img src="{{ asset('medicio/assets/img/gallery/gallery-8.jpg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                    </div>
